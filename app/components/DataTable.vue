<template>
    <div class="w-full space-y-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between sm:gap-4 w-full">
            <!-- Left Section: Column Selector + Slot -->
            <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-3 w-full">
                ...
                <div class="relative" ref="column_selector">
                    <button @click="showColumnSelector = !showColumnSelector"
                        class="inline-flex items-center justify-center w-full sm:w-auto px-3 py-2 border border-gray-300 bg-white text-sm font-medium rounded-md text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-custom-gray">
                        <tr>
                            <th v-if="viewMode === 'card'"
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-10"></th>
                            ...
                            <tr class="hover:bg-custom-gray">
                                <td v-if="viewMode === 'card'" class="px-6 py-4 whitespace-nowrap text-left">
                                    <div class="flex items-center">
                                        <button @click.stop="toggleRowExpand(row.id)"
                                            ...
                                            <svg v-if="!isRowVisible(row.id)" class="h-5 w-5" fill="none"
                                ...
                                <td v-if="showActionBtns"
                                    ...
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <!-- Action Menu -->
                                        <teleport to="body">
                                            <div v-if="activeActionMenu === row.id"
                                                :style="getMenuTeleportStyle(row.id)"
        ...
        <!-- Pagination -->
        <div
            class="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-3 bg-white border-t border-gray-200 sm:px-6">
            <!-- 🔹 Page Info & Page Size Selector -->
            <div class="flex flex-col sm:flex-row items-center sm:space-x-2 text-sm text-gray-700 w-full sm:w-auto">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="hidden sm:inline">of {{ totalItems }} results</span>
                </div>
            </div>

            <!-- 🔹 Pagination Controls -->
            <div class="flex items-center justify-center space-x-1 sm:space-x-2 w-full sm:w-auto">
                <button @click="goToFirstPage" :disabled="currentPage === 1"
                    class="p-1 sm:px-2 sm:py-1 text-gray-500 hover:text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
